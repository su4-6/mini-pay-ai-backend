/**
 * 公安备案图标（官方样式，36×40 PNG，1403 字节）。
 *
 * 数据来源：全国互联网安全管理服务平台备案页脚要求的图标。原图存同目录
 * `police-badge.png`，这里内联成 data URI —— Worker 是「自包含 HTML、无外部资源」
 * 的设计（见 wrangler.toml 注释），内联可以避免新增路由与额外请求。
 *
 * 备案号与链接见 ../src/pages.js 顶部的 POLICE_NUMBER / POLICE_URL。
 */
export const POLICE_BADGE_DATA_URI =
